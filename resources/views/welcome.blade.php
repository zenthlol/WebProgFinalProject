...
<body>
    ...
    <div class="d-flex justify-content-center">
        <div class="d-flex justify-content-center w-100 bg-body-tertiary">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle {{ $active === 'Category' ? 'active' : '' }}"
                        ...
                        <form class="d-flex" action="/welcome">
                            <input class="form-control me-2" name ="search" type="search"
                                placeholder="Search for Book Name" value="{{ request('search') }}">
    ...
    <div class="text-center bg-primary fixed-bottom">
        <p class="text-center pt-3 text-light">@Happy Book Store 2022</p>
    </div>
